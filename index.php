...
.msgInfo{border: 1px solid #333;padding: 5px; }
.msgInfo iframe {min-height: 500px; overflow:auto;}
</style>
<div class="msgTitle">
<span>请先选择导入EXCEL：</span>
</div>
<div class="importInfo">
<form target="testIframeName" id="productForm" action="/file.php" method="post" enctype="multipart/form-data">
...
<div class ="msgInfo">
<iframe id="childPage" name="testIframeName" width="100%"  frameborder="0"></iframe> 
</div>
